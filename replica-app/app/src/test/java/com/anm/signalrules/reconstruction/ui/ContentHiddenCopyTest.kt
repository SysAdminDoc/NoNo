...
class ContentHiddenCopyTest {
    ...
    fun theCommandNamesThisAppAndTheSensitiveNotificationsPermission() {
        val command = sensitiveNotificationsAppOpsCommand("com.anm.signalrules.reconstruction.debug")

        assertEquals(
            "adb shell cmd appops set --user 0 com.anm.signalrules.reconstruction.debug " +
