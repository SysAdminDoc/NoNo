...
fun HistoryActivityScreen(state: UiState, model: MainViewModel) {
    ...
    Column(Modifier.fillMaxSize()) {
        SignalTopBar("Notification activity", onBack = { model.selectRoot(com.sysadmindoc.nono.model.RootTab.HISTORY) })
...
private fun contentStateLabel(trace: RuleEvaluationTrace): String = when (trace.contentState) {
    com.sysadmindoc.nono.model.NotificationContentState.AVAILABLE -> "content available to matcher"
    com.sysadmindoc.nono.model.NotificationContentState.HIDDEN_BY_SYSTEM -> "content hidden by Android"
    com.sysadmindoc.nono.model.NotificationContentState.NOT_AVAILABLE -> "content unavailable"
    com.sysadmindoc.nono.model.NotificationContentState.NOT_STORED -> "content not stored"
}
