...
| DEV-011 | Backup and shortcuts | File-picker handoff exists, but backup serialization, scheduled backup, and launcher-shortcut publication are not implemented. | The audit did not safely execute these effects and no storage format was observable. | Controls hand off safely or return explicit local feedback; report as a material functional gap. |
